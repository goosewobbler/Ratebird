function ratebird_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
ratebird_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				ratebird_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
ratebird_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
ratebird_xmlhttpRequester.prototype.setupRequestEvent =
